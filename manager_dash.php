...
// Fetch all candidates with their complete profiles
try {
    $conn = getDBConnection();
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($candidate['shortlist_status']): ?>
                                            <span class="badge bg-<?php 
                                                echo $candidate['shortlist_status'] === 'shortlisted' ? 'success' : 
                                                    ($candidate['shortlist_status'] === 'rejected' ? 'danger' : 'warning'); 
                                            ?>">
                                                <?php echo ucfirst($candidate['shortlist_status']); ?>
                                            </span>
                                            <?php else: ?>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="status" class="form-select" required>
                                                                <option value="pending" <?php echo $candidate['shortlist_status'] === 'pending' ? 'selected' : ''; ?>>Pending</option>
                                                                <option value="shortlisted" <?php echo $candidate['shortlist_status'] === 'shortlisted' ? 'selected' : ''; ?>>Shortlisted</option>
                                                                <option value="rejected" <?php echo $candidate['shortlist_status'] === 'rejected' ? 'selected' : ''; ?>>Rejected</option>
                                                            </select>
                                                        </div>
